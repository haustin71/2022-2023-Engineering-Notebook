...
Proof that I completed the assignment can be found [here](https://drive.google.com/file/d/1gXm_q0GuKIwf2bQAusHXyGtgnoYSu_NE/view)

![Temp Sensor Wiring Diagram](https://github.com/haustin71/Circuit-Python/blob/8a94a191eccf9552e63e1930c6c17e880ba3f026/Images%20and%20Videos/Temp%20sensor.PNG)
...
Proof can be found [here](https://drive.google.com/file/d/1dTmfWFnzzZsosa02e_RmEMOMPM2Gd2NW/view)
...
### Reflection
Overall, I think that the test went well and I'm glad that I passed. I think that the assignment that we were given to study for the exam were really helpful especially the single part studio assignment. I think that all of the study materials worked really well for preparing for the test, the only thing that I think the teachers could improve on was adding more of an emphasis on the time limit because I know for me, the time limit was the hardest part of the test. I think that the test was a accurate representation of what we learned in onshape and I hope that charlottesville highschool engineering department will continue to give students the test. 
